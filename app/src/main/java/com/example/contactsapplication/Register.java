            ...
            public void onClick(View view) {
                ...
                else
                {
                    if(etPassword.getText().toString().trim().equals(etReEnter.getText().toString().trim()))
                    {
                        ...
                        BackendlessUser user=new BackendlessUser();//new user
                        user.setEmail(email);
                        user.setPassword(password);
                        user.setProperty("name",name);

                        showProgress(true);
                        tvLoad.setText("Busy registering you..please wait..");
                        ...
                        Backendless.UserService.register(user, new AsyncCallback<BackendlessUser>() {
                            ...
                            public void handleResponse(BackendlessUser response) {
                                ...
                                showProgress(false);
                                Toast.makeText(Register.this, "User succesfully register", Toast.LENGTH_SHORT).show();
